...
"""
Code copied from https://github.com/cake-lab/datafree-model-extraction 
GeneratorA is used to generate images for data free adverasarial training of pix2pix model
"""
